...
export default {
    ...
    methods:{
        ...
        Touch1(){
            ...
            this.$router.push({name:'ServicesVue'});
        ...
        Touch3(){
            ...
            this.$router.push({name:'AffiliateProgram'});
        ...
        Pointer1(){
            ...
            this.$router.push({name:'ShippingVue'});
            
        },
        Pointer2(){
            
            this.$router.push({name:'OrderStatuts'});
            
        },
        Pointer3(){
            
            this.$router.push({name:'PayementOptions'});
